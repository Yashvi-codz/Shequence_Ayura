              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    ringColor:
                      dosha === doshaResult.dominant ? d.color : "transparent",
                  }}
                >
        ...
        <div className="card mb-6">
          ...
          {editing ? (
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="text-sm font-semibold text-gray-text">
                    Age
                  </label>
                ...
                <div>
                  ...
                  <p className="text-lg text-dark-text capitalize">
                    {user.gender || "Not set"}
                  </p>
                </div>
                <div>
              ...
              <div>
                <label className="text-sm font-semibold text-gray-text block mb-2">
                  Health Goals
                </label>
              ...
              <div>
                ...
                <p className="text-dark-text">
                  {user.dietaryRestrictions || "None specified"}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-dark-text">
                  {user.currentHealthIssues || "None specified"}
                </p>
              </div>
            </div>
          )}
