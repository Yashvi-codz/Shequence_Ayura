      ...
      <div className="max-w-2xl mx-auto">
        <div className="card">
          <h2 className="text-3xl font-bold mb-2 text-dark-text">
            Let's Personalize Your Wellness
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {healthGoalOptions.map((goal) => (
                  <label
                    key={goal}
                    className="flex items-center p-3 border-2 rounded-lg cursor-pointer hover:border-primary transition-colors"
                    style={{
            ...
            <div>
              <label className="block text-sm font-semibold mb-2">
                Current Health Issues (optional)
              </label>
              <textarea
                className="input-field"
                rows="3"
